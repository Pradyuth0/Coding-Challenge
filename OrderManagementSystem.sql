...
select * from user;
 ...
 CREATE TABLE Orders(orderId INT PRIMARY KEY,order_date DATE,productId INT,userId INT,FOREIGN KEY (productId) REFERENCES Product(productId),
FOREIGN KEY (userId) REFERENCES User(userId));
    
INSERT INTO Orders VALUES(1, '2023-01-04', 1, 2);
INSERT INTO Orders VALUES(2, '2023-11-26', 2, 1);
INSERT INTO Orders VALUES(3, '2023-11-30', 3, 3);
INSERT INTO Orders VALUES(4, '2023-11-09', 4, 2);
INSERT INTO Orders VALUES(5, '2023-12-10', 5, 1);
INSERT INTO Orders VALUES(6, '2023-12-06', 1, 3);
...
create table OrderTable(userId int, 
						productId int,
						FOREIGN KEY (productId) REFERENCES product(productId),
						FOREIGN KEY (userId) REFERENCES User(userId));
