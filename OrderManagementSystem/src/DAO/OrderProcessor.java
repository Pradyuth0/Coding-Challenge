...
public class OrderProcessor implements IOrderManagementRepository
{
	    ...
	    public void cancelOrder(int userId, int orderId) {
	        try {
	            if (userExists(userId)) {
	                ...
	                {
	                    String deleteOrderQuery = " DELETE FROM orders WHERE userId=? and orderId=? ";
	                    ...
	                    throw new OrderNotFoundException("Order with orderID: "+orderId+" and UserID: "+userId+" does not exist.");
	                }
	            } else {
	    ...
	    private boolean orderExists(int orderId, int userId) throws SQLException {
	        String orderExistsQuery = "SELECT * FROM orders WHERE userId = ? AND orderId = ?";
